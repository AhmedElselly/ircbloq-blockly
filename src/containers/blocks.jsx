...
class Blocks extends React.Component {
    ...
    handleExtensionAdded (categoryInfo) {
        ...
        // ircbloq-blocks implements a menu or custom field as a special kind of block ("shadow" block)
     ...
     * to the variable validation prompt callback used in ircbloq-blocks.
     */
