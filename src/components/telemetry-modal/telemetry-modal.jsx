...
const messages = defineMessages({
    label: {
        ...
        defaultMessage: 'Report statistics to improve IrcBloq',
        description: 'IrcBloq telemetry modal label - for accessibility'
    },
    bodyText1: {
        defaultMessage: 'The IrcBloq Team is always looking to better understand how IrcBloq is used around the ' +
            'world. To help support this effort, you can allow IrcBloq to automatically send usage information to ' +
            'the IrcBloq Team.',
    ...
    privacyPolicyLink: {
        ...
        description: 'Link to the IrcBloq privacy policy',
        id: 'gui.telemetryOptIn.privacyPolicyLink'
    },
    optInText: {
        defaultMessage: 'Share my usage data with the Ircbloq Team',
    ...
    optOutText: {
        defaultMessage: 'Do not share my usage data with the Ircbloq Team',
        description: 'Text for telemetry modal opt-in button',
                    ...
                    <p><FormattedMessage
                        ...
                        values={{
                            privacyPolicyLink: (<a
                                ...
                                href="https://ircbloq.cc/privacy_policy/"
